...
dev.print(png, filename = "Results/1.1_Fig1.png", res = 100, 
  width = dev.size()[1], height = dev.size()[2], units = "in")
dev.copy2eps(file = "Results/1.1_Fig1.eps")
...
dev.print(png, filename = "1.1_Fig2.png", res = 100, 
  width = dev.size()[1], height = dev.size()[2], units = "in")
dev.copy2eps(file = "Results/1.1_Fig2.eps")
